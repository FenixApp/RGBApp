...
class ColorViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        areaColors.backgroundColor = viewColor
    ...
    @IBAction func actionSliderRGB(_ sender: UISlider) {
        
        switch sender {
        case redSlider:
            setValue(for: valueRedSlider)
            setValue(for: redTextField)
        case greenSlider:
            setValue(for: valueGreenSlider)
            setValue(for: greenTextField)
        default:
            setValue(for: valueBlueSlider)
    ...
    @IBAction func doneButtonPressed() {
        delegate?.setColor(areaColors.backgroundColor ?? .white)
...
extension ColorViewController {
    ...
    private func setValue(for labels: UILabel...) {
        labels.forEach { label in
            switch label {
            case valueRedSlider: label.text = string(from: redSlider)
            case valueGreenSlider: label.text = string(from: greenSlider)
